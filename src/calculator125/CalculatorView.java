...
public class CalculatorView extends JFrame {
	...
	private final JLabel multiSignLabel    = new JLabel("*");
	private final JTextField secondFactor = new JTextField(10);
	private final JButton calculateProduct = new JButton("Multiply");
	...
	CalculatorView() {
        ...
        //  JButton component to the JPanel named calcPanel.
            ...
            calcPanel.add(firstFactor);
            calcPanel.add(multiSignLabel);
            calcPanel.add(secondFactor);
            calcPanel.add(calculateProduct);
            calcPanel.add(productValue);
